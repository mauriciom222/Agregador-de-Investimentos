...
public class AccountStock {
    ...
    @ManyToOne
    @MapsId("accountId")//nome do atributo dentro do AccountStockId
    @JoinColumn(name="account_id")
    private Account account;

    @ManyToOne
    @MapsId("stockId")//nome do atributo dentro do AccountStockId
    @JoinColumn(name="stock_id")
    private Stock stock;

    @Column(name = "quantity")//quantidade de ações daquela stock naquela conta
